      ...
      <div>
         ...
         <div id="ContentWrapper" data-cols="2" data-view1="1" data-view2="2" data-view3="2" data-view4="2" class="row-fluid subpageBody">
                <div class="span bp0-col-1-1 bp2-col-2-1 bp3-col-2-1 bp1-col-2-2">
                    ...
                    <p>Office 365 operated by 21Vianet provides online productivity and collaboration solutions. 21Vianet offers trusted Office 365 service that helps enterprises expand their businesses and maintain compliance with industry requirements.</p>
                    ...
                    <label>Security: Our comprehensive approach</label>
                            ...
                            <ul type="circle">
                                ...
                                <li>
                                    <ul>
                                        ...
                                        <li>To download a copy of end-user metadata (such as email address, first and last name, and other data), you can use PowerShell cmdlets, including the Get-MsolUser Windows PowerShell cmdlet for Office 365. If you use Exchange Online, you can also use the Get-MailUser and Get-User Exchange PowerShell command</li>
                                    </ul>
                                </li>
                    ...
                    <label class="subhead">Customer controls for organizational complian</label>
                    <ul>
                    ...
                    <label>Transparent operations </label>
                    ...
                    <ul>
                        ...
                        <li>We have processes in place to provide around-the-clock escalation to the actual development team to resolve issues that cannot be resolved by operations alone.</li>
                    </ul>
                    <label class="subhead">We are accountable to you</label>
                    <ul>
                        <li>We conduct a thorough review of all service incidents which you use , 
                            <ul type="circle">
                    ...
                    <label class="subhead">Office 365 Service Health Dashboard</label>
                    <img src="" alt=""> <!-- 等待图片链接 -->
